...
public class JdbcUserDao implements UserDao {
	...
	public void insertUser(User user) {
		// TODO Auto-generated method stub
		jdbcTemplate.update(sqlService.getSql("insertUser"), user.getUserKey(), user.getStatusCode().getValue(),
	...
	public void updatdUser(User user) {
		// TODO Auto-generated method stub
		jdbcTemplate.update(sqlService.getSql("updateUser"), user.getStatusCode().getValue(), user.getSubStatusValue(),
				user.getUserKey());
	}
